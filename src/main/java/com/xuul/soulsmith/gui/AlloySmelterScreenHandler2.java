...
public class AlloySmelterScreenHandler2 extends SyncedGuiDescription {
    protected final World world;
    protected final RecipeType<? extends AlloyRecipe> recipeType;

    protected AlloySmelterScreenHandler2(ScreenHandlerType<?> type, RecipeType<? extends AlloyRecipe> recipeType, int syncId, PlayerInventory playerInventory) {
    ...
    public AlloySmelterScreenHandler2(ScreenHandlerType<?> type, RecipeType<? extends AlloyRecipe> recipeType, int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
